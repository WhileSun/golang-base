...
type AddMenu struct {
	...
	DataPermsHeader string   `form:"data_perms_header" label:"数据权限标识前缀"`
	TargetKeys      []string `form:"target_keys" label:"赋予节点"`
	OldTargetKeys   []string `form:"old_target_keys" label:"历史赋予节点"`
}
